...
// this is the first layer.
  ...
  OSM(MOD_LSFT),   KC_Z,      KC_X,      KC_C,      KC_V,       KC_B,   KC_TRANSPARENT,
  ...
  KC_TRANSPARENT,   KC_6,      KC_7,     KC_8,       KC_9,      KC_0,      ES_APOS,
  KC_ESCAPE,        KC_Y,      KC_U,     KC_I,       KC_O,      KC_P,      ES_CCED,
                    KC_H,      KC_J,     KC_K,       KC_L,      ES_NTIL,   ES_ACUT,
  KC_TRANSPARENT,   KC_N,      KC_M,     KC_COMMA,   KC_DOT,    ES_MINS,   OSM(MOD_RSFT),
                               KC_UP,    KC_DOWN,    ES_GRV,    ES_PLUS,   TG(2),
...
// Layout 1: Functions and movement
  ...
  KC_TRANSPARENT, KC_MS_WH_LEFT,  KC_MS_WH_UP,    KC_MS_WH_DOWN, KC_MS_WH_RIGHT, KC_PC_CUT,     KC_ESCAPE,
  KC_TAB,         KC_MS_LEFT,     KC_MS_UP,       KC_MS_DOWN,    KC_MS_RIGHT,    KC_PC_COPY,
  OSM(MOD_LSFT),  KC_LEFT,        KC_UP,          KC_DOWN,       KC_RIGHT,       KC_PC_PASTE,   KC_TRANSPARENT,
  TG(1),          KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT,       KC_RIGHT,

              KC_MS_BTN3, KC_TRANSPARENT,
                          KC_HOME,
  KC_MS_BTN2, KC_MS_BTN1, KC_END,
  ...
  KC_TRANSPARENT, KC_MS_BTN3,
  KC_PGUP,
  KC_PGDOWN,      KC_MS_BTN1, KC_MS_BTN2),
...
// selected in the OS.
  ...
  KC_TRANSPARENT,  KC_B,  KC_M,    KC_W,     KC_V,    KC_Z,     OSM(MOD_RSFT),
                          KC_UP,   KC_DOWN,  ES_GRV,  ES_PLUS,  TG(2),
