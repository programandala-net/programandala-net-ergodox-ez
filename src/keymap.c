...
// Version 0.1.0-dev.1+20190621
 
// By Marcos Cruz (programandala.net)

// 2019-06-21

// https://configure.ergodox-ez.com/ergodox-ez/layouts/WvQEy/latest/0
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox(ES_IEXL,KC_1,KC_2,KC_3,KC_4,KC_5,KC_ESCAPE,KC_CAPSLOCK,KC_KP_DOT,KC_COMMA,ES_NTIL,KC_P,KC_Y,KC_TRANSPARENT,KC_TAB,KC_A,KC_O,KC_E,KC_U,KC_I,KC_LSHIFT,KC_MINUS,KC_Q,KC_J,KC_K,KC_X,KC_TRANSPARENT,TG(1),ES_OVRR,ES_LESS,KC_LEFT,KC_RIGHT,KC_LCTRL,KC_LALT,KC_HOME,KC_BSPACE,KC_DELETE,KC_END,KC_ESCAPE,KC_6,KC_7,KC_8,KC_9,KC_0,KC_QUOTE,KC_TRANSPARENT,KC_F,KC_G,KC_C,KC_H,KC_L,ES_CCED,KC_D,KC_R,KC_T,KC_N,KC_S,ES_APOS,KC_TRANSPARENT,KC_B,KC_M,KC_W,KC_V,KC_Z,KC_RSHIFT,KC_UP,KC_DOWN,KC_GRAVE,ES_PLUS,TG(1),RALT_T(KC_NO),RCTL_T(KC_NO),KC_PGUP,KC_PGDOWN,KC_ENTER,KC_SPACE),
